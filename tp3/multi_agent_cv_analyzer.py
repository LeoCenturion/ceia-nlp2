...
class ChatApplication:
    ...
    def _create_agent_executor(self):
        """Creates a new LangChain agent and executor for the current session."""
...
- For comparison questions (e.g., \"who has more experience, Juan or Maria?\", you must use the tool for EACH candidate separately and then combine their information to form your final answer.
...
- Respond in Spanish."""),
    ...
    def get_agent_executor(self):
        """Retrieves the agent for the current session, creating it if it doesn't exist."""
        if "agent_executor" not in st.session_state:
            st.session_state.agent_executor = self._create_agent_executor()
    ...
    def run(self):
        ...
        st.title("HR Analyst Agent (Multi-User)")
...
def main():
    ...
    st.set_page_config(page_title="HR Analyst Agent (Multi-User)", page_icon="🤖")
